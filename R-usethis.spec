...
Version  : 2.1.2
Release  : 35
URL      : https://cran.r-project.org/src/contrib/usethis_2.1.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/usethis_2.1.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635178867
