...
Version  : 2.1.0
Release  : 34
URL      : https://cran.r-project.org/src/contrib/usethis_2.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/usethis_2.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634586045
